...
const propsData = [
  ...
  ["weight", "number | string", "900", "Font weight"],
  ["className", "string", "undefined", "Additional CSS class"],
];

export default function GlitchTextDocs() {
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 13, color: "#666", fontFamily: "inherit", marginBottom: 4 }}>
        ...
        <span style={{ color: "#aaa" }}>Glitch Text</span>
      </div>
      ...
      >
        Doctor Glitch font with horizontal slice distortion animation.
      </p>
