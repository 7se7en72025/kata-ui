...
const propsData = [
  ["children", "ReactNode", "required", "Content to lazy load"],
  ["minHeight", "number", "0", "Placeholder height in px"],
  ["className", "string", "undefined", "Additional CSS class"],
];

export default function LazySectionDocs() {
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 13, color: "#666", fontFamily: "inherit", marginBottom: 4 }}>
        ...
        <span style={{ color: "#aaa" }}>Lazy Section</span>
      </div>
      ...
      >
        Lazy-load section with IntersectionObserver for performance optimization.
      </p>
      ...
      {activeTab === "preview" ? (
        ...
        >
          <LazySection minHeight={100}>
            <div style={{ padding: 32, textAlign: "center", color: "#4ade80" }}>
              Content loaded! (Scroll to see lazy loading)
            </div>
          </LazySection>
        </div>
      ) : (
