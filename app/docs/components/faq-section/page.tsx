...
const propsData = [["title", "string", "Questions and Answers", "Section heading"]];
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 13, color: "#666", fontFamily: "inherit", marginBottom: 4 }}>
        ...
        <span style={{ color: "#aaa" }}>FAQ Section</span>
      </div>
      ...
      >
        Collapsible FAQ accordion with smooth animations and keyboard navigation.
      </p>
