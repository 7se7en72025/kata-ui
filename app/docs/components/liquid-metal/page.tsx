...
const propsData = [
  ["colorBack", "string", "#aaaaac", "Background color"],
  ["colorTint", "string", "#ffffff", "Tint color"],
  ["speed", "number", "0.5", "Animation speed"],
  ["repetition", "number", "4", "Shader repetition"],
  ["distortion", "number", "0.1", "Distortion amount"],
  ["scale", "number", "1", "Shader scale"],
  ["className", "string", "undefined", "Additional CSS class"],
];

export default function LiquidMetalDocs() {
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 13, color: "#666", fontFamily: "inherit", marginBottom: 4 }}>
        ...
        <span style={{ color: "#aaa" }}>Liquid Metal</span>
      </div>
      ...
      >
        3D liquid metal shader component with chrome border effect.
      </p>
